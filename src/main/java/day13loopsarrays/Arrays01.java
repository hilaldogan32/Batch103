...
public class Arrays01 {
    ...
    public static void main(String[] args) {
        ...
        stdNames[3] = "Kemal";
        stdNames[4] = "Cem";
            //{"Ali", "Tom", "Veli", "Kemal", "Cem"}
        int karakterSayilariToplami = 0;//3,6,10,15,18

        for(String w : stdNames){                                //"Ali""Tom","Veli""Kemal","Cem"
        ...
        //           Bu array;deki sadece buyük harfleri ekrana yazdiriniz
