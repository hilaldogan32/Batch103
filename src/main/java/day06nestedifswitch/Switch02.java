...
public class Switch02 {
    ...
    /*
        Kullaniciya ay ismi sorunuzve kullanicinin verdigi ay isminden son aya kadar ekrana yazdiriniz

     */
        //Note: toLowerCase() metodu bir String'deki tum character'leri kucuk harflere cevirir
